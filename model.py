...
# Calibrated 2026 Dataset (Representative samples)
data = {
    ...
    'price':     [7.5, 18, 38, 68, 32, 68, 115, 230, 88, 175, 680, 59] 
}

df = pd.DataFrame(data)

# Pipeline ensures scaling is applied consistently
pipeline = Pipeline([
...
print("✅ Advanced Brain Ready (model.pkl)")